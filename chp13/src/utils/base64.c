...
size_t base64_encode(const base64_t *b64, char *out, const void *in, size_t len, int flag)
{
...
size_t base64_decode(const base64_t *b64, void *out, const char *in, size_t len, int flag)
{
    unsigned char *detab = (unsigned char *)b64->detab;
    unsigned char *d = (unsigned char *)out;
    unsigned char *s = (unsigned char *)in;
    unsigned char *end = ((size_t)len < 0) ? (unsigned char *)-1 : s + len;
    int c, x, r, n;
