...
//
//===----------------------------------------------------------------------===//
#ifndef BMC_ADT_HASH_MAP
#define BMC_ADT_HASH_MAP

#ifdef WIN32
#include "sysdef/cpucfg_win32.h" //commented @ 2012.07.02
#else
#include "sysdef/cpucfg_linux_x64.h"
#endif
...
namespace stdext {
    ...
    public:
        ...
        size_t operator()(const Key& key) const { return boost::hash<Key>()(key); }
