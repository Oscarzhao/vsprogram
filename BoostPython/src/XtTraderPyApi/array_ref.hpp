/********************************************************************
	...
	fileName:	array_ref.hpp
	author:		http://stackoverflow.com/questions/17885639/exposing-a-c-style-array-data-member-to-python-via-boost-python   
	created:	2015-04-03	
	purpose:	用于向python输出 char array
*********************************************************************/
#include <cstddef>
#include <iterator>
#include <stdexcept>
